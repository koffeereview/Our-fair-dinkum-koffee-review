...
export default async function handler(req,res){
  try{
    ...
    var cards=nearby.map(function(cf,i){
      ...
      return'<a href="/review/'+cf.sl+'" style="display:flex;align-items:center;gap:14px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:14px;padding:14px 18px;margin-bottom:8px;text-decoration:none;color:inherit"><div style="font-size:12px;color:rgba(255,255,255,0.3);width:22px;text-align:center;flex-shrink:0">'+(i+1)+'</div><div style="width:44px;height:44px;border-radius:50%;border:2px solid '+col+';display:flex;align-items:center;justify-content:center;flex-shrink:0"><span style="font-family:Bebas Neue,sans-serif;font-size:18px;color:'+col+'">'+cf.sc.toFixed(1)+'</span></div><div style="flex:1;min-width:0"><div style="font-size:14px;font-weight:600;color:#fff">'+esc(cf.n)+'</div><div style="font-size:11px;color:rgba(255,255,255,0.4)">'+esc(cf.s)+' &middot; '+(cf.d<1?(cf.d*1000).toFixed(0)+'m':cf.d.toFixed(1)+'km')+' away</div></div><div style="padding:3px 10px;border-radius:20px;font-size:9px;font-weight:700;letter-spacing:1.5px;background:'+col+'18;color:'+col+';border:1px solid '+col+'40;flex-shrink:0">'+v+'</div></a>';
    }).join("");
    ...
    return res.status(200).send('<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Best Coffee Near '+esc(lm.n)+' '+year+' | Koffee Review</title><meta name="description" content="'+nearby.length+' reviewed cafes within walking distance of '+esc(lm.n)+'. Ranked by distance. Scored out of 10."><link rel="canonical" href="https://koffeereview.com.au/coffee-near/'+lm.s+'"><link rel="icon" href="/logo.webp"><link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=DM+Sans:wght@400;500;600&display=swap" rel="stylesheet"><style>'+CSS+'</style></head><body><div class="c">'+NAV+'<div style="font-size:12px;color:rgba(255,255,255,0.35);padding:12px 0"><a href="/" style="color:#E6C073;text-decoration:none">Home</a> &middot; <a href="/coffee-near" style="color:#E6C073;text-decoration:none">Coffee Near</a> &middot; '+esc(lm.n)+'</div><div style="padding:16px 0 16px"><div style="font-size:10px;letter-spacing:3px;color:rgba(230,192,115,0.5);margin-bottom:8px">'+catLabel+'</div><h1 style="font-family:Bebas Neue,sans-serif;font-size:clamp(24px,6vw,36px);letter-spacing:2px;color:#fff;margin-bottom:8px">Best Coffee Near '+esc(lm.n)+'</h1><p style="font-size:14px;color:rgba(255,255,255,0.5);line-height:1.6">'+nearby.length+' reviewed cafes within 3km. Ranked by distance. All scored with one latte and one double shot espresso.</p></div>'+cards+'<div style="margin-top:24px;display:flex;flex-direction:column;gap:8px"><a href="/coffee-near" style="display:flex;align-items:center;justify-content:space-between;padding:13px 16px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:14px;text-decoration:none;color:rgba(255,255,255,0.5);font-size:13px">All '+LM.length+' Locations</a><a href="/explore" style="display:flex;align-items:center;justify-content:space-between;padding:13px 16px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:14px;text-decoration:none;color:rgba(255,255,255,0.5);font-size:13px">Explore</a></div>'+FT+'</div></body></html>');
