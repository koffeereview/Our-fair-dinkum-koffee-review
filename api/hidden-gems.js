...
export default async function handler(req, res) {
  try {
    ...
    const html = "<!DOCTYPE html><html lang=\"en\"><head>" +
      ...
      rows +
      "</div>" +
      "<div class=\"footer\"><p>All caf\u00e9s scored 7.1 or above. One latte and one double shot espresso, every visit.<br/><a href=\"/how-we-score.html\" style=\"color:#c8a96e;\">Read how we score \u2192</a></p>" +
