...
var INTROS = {
  "newstead":"Newstead has quietly become one of Brisbane's most reliable suburbs for quality coffee. The industrial meets boutique strip along Longland Street draws serious roasters and skilled baristas. With {count} cafes reviewed and an average of {avg}/10, it punches consistently above its weight.",
  "west end":"West End is Brisbane's most eclectic coffee suburb. Part student haunt, part specialty roaster territory. The diversity of cafes here reflects the suburb itself: independent, a little unpredictable, and occasionally brilliant. {count} cafes reviewed, average {avg}/10.",
  "fortitude valley":"Fortitude Valley lives on two speeds: late night and early morning coffee. The daytime cafe scene here is sharper than most people expect. Specialty roasters have quietly taken root alongside the Brunswick Street institutions. {count} cafes reviewed, average {avg}/10.",
  "cbd":"Brisbane CBD is the most reviewed suburb in our database with {count} cafes scored. The range is wide, from quick pre meeting espresso bars to proper specialty destinations hidden down laneways. Average score is {avg}/10. Use our rankings to skip the tourist traps.",
  "paddington":"Paddington's Given Terrace is one of the most walkable cafe strips in Brisbane. Compact, high quality, and locals first. {count} cafes reviewed with an average of {avg}/10. Nearly every cafe here takes its coffee seriously.",
  "burleigh heads":"Burleigh Heads consistently outperforms the rest of the Gold Coast for coffee quality. While the tourist strip further north disappoints, Burleigh's back streets and beachside cafe scene delivers genuine specialty coffee. {count} cafes reviewed, average {avg}/10.",
  "south brisbane":"South Brisbane sits between the cultural precinct and the river, and its cafe scene matches that energy. Strong espresso bars, reliable quality, and a few genuine standouts in the mix. {count} cafes reviewed, average {avg}/10.",
  ...
  "woolloongabba":"Woolloongabba is Brisbane's most underrated coffee suburb. Post stadium development has brought serious cafe investment to the area and the scores reflect it. {count} cafes reviewed, average {avg}/10."
};
...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    @media(max-width:480px){.cc-nt{max-width:200px}.tp-ring{width:54px;height:54px}.tp-score{font-size:22px}}
  </style>
</head>
<body>
<div class="pg">
