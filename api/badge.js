...
function buildDarkBadge(name, score, suburb, slug) {
  ...
  <!-- Header — KOFFEE REVIEW with brand logo -->
  <circle cx="36" cy="32" r="14" fill="url(#logoGrad)"/>
  <circle cx="36" cy="32" r="14" fill="none" stroke="#F6DDAA" stroke-width="0.5" opacity="0.6"/>
  <text x="36" y="37" font-family="Georgia,serif" font-size="15" font-weight="700" fill="#0a0a0a" text-anchor="middle">K</text>
...
function buildLightBadge(name, score, suburb, slug) {
  ...
  <circle cx="36" cy="32" r="14" fill="url(#logoGradL)"/>
  <circle cx="36" cy="32" r="14" fill="none" stroke="#C49A3C" stroke-width="0.5" opacity="0.5"/>
  <text x="36" y="37" font-family="Georgia,serif" font-size="15" font-weight="700" fill="#E6C073" text-anchor="middle">K</text>
