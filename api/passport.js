...
export default async function handler(req,res){
  try{
    ...
    // Stats bar
    +'<div style="display:flex;gap:0;margin:16px 0;background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.06);border-radius:14px;overflow:hidden"><div style="flex:1;text-align:center;padding:12px 8px"><div style="font-family:Bebas Neue,sans-serif;font-size:22px;color:#E6C073" id="savedCount">0</div><div style="font-size:8px;letter-spacing:2px;color:rgba(255,255,255,0.3)">WANT TO TRY</div></div><div style="flex:1;text-align:center;padding:12px 8px;border-left:1px solid rgba(255,255,255,0.03);border-right:1px solid rgba(255,255,255,0.03)"><div style="font-family:Bebas Neue,sans-serif;font-size:22px;color:#4ade80" id="visitedCount">0</div><div style="font-size:8px;letter-spacing:2px;color:rgba(255,255,255,0.3)">VISITED</div></div><div style="flex:1;text-align:center;padding:12px 8px"><div style="font-family:Bebas Neue,sans-serif;font-size:22px;color:#2dd4bf" id="returnCount">0</div><div style="font-size:8px;letter-spacing:2px;color:rgba(255,255,255,0.3)">WOULD RETURN</div></div></div>'
    ...
    // Render cafe card
    +'function cafeCard(slug,extra){var c=CM[slug];if(!c)return"<div class=\\"card\\"><div style=\\"flex:1;font-size:13px;color:rgba(255,255,255,0.3)\\">"+slug+"</div></div>";'
    +'var col="'+"#E6C073"+'";'
    +'return\'<a href="/review/\'+slug+\'" class="card"><div style="width:40px;height:40px;border-radius:50%;border:2px solid \'+col+\';display:flex;align-items:center;justify-content:center;flex-shrink:0"><span style="font-family:Bebas Neue,sans-serif;font-size:16px;color:\'+col+\'">\'+c.sc.toFixed(1)+\'</span></div><div style="flex:1;min-width:0"><div style="font-size:14px;font-weight:600;color:#fff">\'+c.n+\'</div><div style="font-size:11px;color:rgba(255,255,255,0.35)">\'+c.s+\', \'+c.c+(extra?" &middot; "+extra:"")+"</div></div><div style=\\"font-size:12px;color:rgba(255,255,255,0.15)\\">&rarr;</div></a>\';}'
